...
<br />
                        ...
                        Before I decided to make web development as my primary profession,
...
<br />
                        <br />
                        <b className="about-title" style={{ fontSize: '20px' }}>What am i up to now :</b><br />

                        As the quote on top of this page says, I am trying to be better then tomorrow me , I'm constantly learning and self developing. </p>
                </div>
            </div>
        )
    }
